...
function Index() {
  ...
  return (    
    ...
    <h1 className='text-2xl mb-16 leading-normal transition-colors duration-700 delay-500 text-slate-900 md:text-4xl dark:text-white'>
    ...
    <Link to='register'>
      <button 
        className='w-full py-2 my-4 text-lg tracking-wide text-white transition-colors duration-700 delay-500 rounded-md bg-slate-900'
      >
        Get Started
      </button><br />
    </Link>
    <Link to='/shows'>
      <button 
        className='w-full py-1 text-lg tracking-wide transition-colors duration-700 delay-500 border-4 rounded-md text-slate-900 border-slate-900'
      >
        Browse
      </button>
    </Link>
    ...
    />
    <p className='text-2xl leading-normal text-black dark:text-white'>Our kids are spending more time on screens than ever before.</p>
