...
function Browse() {
  ...
  return (
    <div className='flex flex-col items-start px-10 mt-28'>
      <h3 
        className='text-2xl transition-colors duration-700 delay-500 text-slate-900 dark:text-white'
      >
        Discover the shows that fit your child's needs.
      </h3>
      <Link to='/focus' className='py-4 mt-20 text-2xl tracking-wide transition-colors duration-700 delay-500 text-slate-900 dark:text-white'>Focus</Link>
      <p 
        className='pb-4 tracking-wide transition-colors duration-700 delay-500 text-slate-800 dark:text-slate-400'
      >
      ...
      <Link to='/ages' className='pb-4 text-2xl tracking-wide transition-colors duration-700 delay-500 text-slate-900 dark:text-white'>Age</Link>
      <p 
        className='pb-4 tracking-wide transition-colors duration-700 delay-500 text-slate-800 dark:text-slate-400'
      >
