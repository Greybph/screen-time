    ...
    <div>
      <Form method="post" aciton='/account' className="max-w-sm px-10 py-8 mx-auto mt-24 bg-transparent">
        ...
        <div className="space-y-4">
          <h1 className="text-2xl text-center transition-colors duration-700 delay-500 text-slate-900 dark:text-white">Login</h1>
          <div>
      ...
      <p className='text-center text-gray-600 transition-colors duration-700 delay-500 dark:text-slate-500'>Or create an account</p>
     
        <div className='flex justify-center'>
          <Link 
          to='/register'
          className='text-center underline transition-colors duration-700 delay-500 cursor-pointer text-slate-900 dark:text-white'
          >
            Sign-up
          </Link>
        </div>
